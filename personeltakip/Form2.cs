...
//System.Text.RegularExpression(Regex) tanımlama 
using System.Text.RegularExpressions;
//Giriş çıkış işlemleri için ktphane tanımlama
using System.IO;
...
namespace personeltakip
{
    public partial class Form2 : Form
    {
        ...
        private void personelleri_goster()
        {
            try
            {
                ...
                OleDbDataAdapter personelleri_listele = new OleDbDataAdapter("select tcno AS[TC KİMLİK NO],ad AS[ADI],soyad AS[SOYADI]," +
                    "cinsiyet AS[CİNSİYETİ],mezuniyet AS[MEZUNİYETİ]," +
                    "dogumtarihi AS[DOĞUM TARİHİ],gorevi AS[GÖREVİ],gorevyeri AS[GÖREV YERİ]," +
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(textBox6, "Parola Tekrarı Eşit Değil");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (kayitkontrol == false)
            {
                ...
                if (textBox1.Text.Length == 11 && textBox1.Text != "" && textBox2.Text != "" && textBox2.Text.Length > 1 && textBox3.Text != "" &&
                    textBox3.Text.Length > 1 && textBox4.Text != "" &&
                    textBox5.Text != "" && textBox6.Text != "" && textBox5.Text == textBox6.Text && parola_skoru >= 70)
                {
                    ...
                    {
                        baglantim.Open();
                        OleDbCommand eklekomutu = new OleDbCommand("insert into kullanicilar values" +
                            "('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + yetki + "'" +
                            ",'" + textBox4.Text + "','" + textBox5.Text + "')", baglantim);
                        eklekomutu.ExecuteNonQuery();//access e işle
                        baglantim.Close();
                        kullanicilari_goster();
                        MessageBox.Show("Yeni kullanıcı kaydı oluşturuldu!", "Personel Takip Sistemi",
                ...
                {
                    MessageBox.Show("Kırmızı Alanları Tekrar Gözden Geçiriniz!", "Personel Takip Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lutfen 11 haneli bir TC Kimlik No giriniz!", "Personel Takip Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                topPage1_temizle();
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
                ...
                textBox5.Text != "" && textBox6.Text != "" && textBox5.Text == textBox6.Text && parola_skoru >= 70)
            {
                ...
                {
                    baglantim.Open();
                    OleDbCommand guncellekomutu = new OleDbCommand("update  kullanicilar set ad='" + textBox2.Text + "'" +
                        ",soyad='" + textBox3.Text + "',yetki='" + yetki + "',kullaniciadi='" + textBox4.Text + "'" +
                        ",parola='" + textBox5.Text + "' where tcno='" + textBox1.Text + "'", baglantim);
                    guncellekomutu.ExecuteNonQuery();//access e işle
                    baglantim.Close();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (textBox1.Text.Length == 11)
            {
                bool kayit_arama_durumu = false;
                baglantim.Open();
                OleDbCommand selectsorgu = new OleDbCommand("select * from kullanicilar where " +
                    "tcno='" + textBox1.Text + "'", baglantim);
                OleDbDataReader kayitokuma = selectsorgu.ExecuteReader();
                while (kayitokuma.Read())
                {
                    kayit_arama_durumu = true;
                    OleDbCommand deletesorgu = new OleDbCommand("delete from kullanicilar where " +
                        "tcno='" + textBox1.Text + "'", baglantim);
                    deletesorgu.ExecuteNonQuery();
                    MessageBox.Show("Kullanıcı Kaydı Silindi!", "Personel Kayıt Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    baglantim.Close();
                    kullanicilari_goster();
                    topPage1_temizle();
                    break;
                ...
                if (kayit_arama_durumu == false)
                {
                    MessageBox.Show("Silinecek Kayıt Bulunamadı!", "Personel Kayıt Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                MessageBox.Show("Lütfen 11 karakterden oluşan TC no giriniz!", "Personel Takip Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (kayitkontrol == false)
            {
                    ...
                    comboBox1.Text != "" && comboBox2.Text != "" && comboBox3.Text != "" && maskedTextBox4.MaskCompleted != false)
                {
                    ...
                    try
                    {
                        ...
                        OleDbCommand eklekomutu = new OleDbCommand("insert into personeller values " +
                            "('" + maskedTextBox1.Text + "','" + maskedTextBox2.Text + "','" + maskedTextBox3.Text + "','" + cinsiyet + "','" + comboBox1.Text + "'," +
                            "'" + dateTimePicker1.Text + "','" + comboBox2.Text + "','" + comboBox3.Text + "','" + maskedTextBox4.Text + "')", baglantim);
                        ...
                        MessageBox.Show("Yeni personel kaydı oluşturuldu.", "Personel Kayıt Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        personelleri_goster();
                        topPage2_temizle();
                        maskedTextBox4.Text = "0";
                    }
                ...
                {
                    MessageBox.Show("Kırmızı alanları tekrar doldurunuz!", "Personel Takip Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }

            else
            {
                MessageBox.Show("Girilen TC No kayıtlıdır!", "Personel Takip Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            ...
            if (maskedTextBox1.Text.Length == 11)
            {
                ...
                while (kayitokuma.Read())
                {
                    ...
                    catch
                    {
                        ...
                        pictureBox2.Image = Image.FromFile(Application.StartupPath + "\\personelresimler\\carcar.jpg");
                    }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
                ...
                comboBox1.Text != "" && comboBox2.Text != "" && comboBox3.Text != "" && maskedTextBox4.MaskCompleted != false)
            {
                ...
                {
                    baglantim.Open();
                    OleDbCommand guncellekomutu = new OleDbCommand("update personeller set ad='" + maskedTextBox2.Text + "'" +
                        ",soyad='" + maskedTextBox3.Text + "'" +
                        ",cinsiyet='" + cinsiyet + "',mezuniyet='" + comboBox1.Text + "',dogumtarihi='" + dateTimePicker1.Text + "'" +
                        ",gorevi='" + comboBox2.Text + "',gorevyeri='" + comboBox3.Text + "',maasi='" + maskedTextBox4.Text + "' " +
                        "where tcno='" + maskedTextBox1.Text + "'", baglantim);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen 11 haneli TC no giriniz", "Personel Takip Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                topPage2_temizle();
                maskedTextBox4.Text = "0";
            }
        }
